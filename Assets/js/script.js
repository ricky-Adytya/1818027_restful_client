const baseUrl = "http://localhost:8080/restful-api/index.php";

const baseEndPoin = `${baseUrl}/genshin`;
    ...
    .then(resJson => {
        ...
        <div class="card horizontal">
          ...
          <div class="card-stacked">
            ...
            <p>Nama pendek: ${resJson.shortName} <br>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll(".sidenav a, .topnav a, .collapsible").forEach(elm => {
